...
export default {
    ...
    ctx.fill()
        ...
        BezierEllipse(ctx, x, y, a, b){
            ...
            //绘制第一段
            ctx.bezierCurveTo(pointFrist.posX-a, y-b,pointFrist.posX-a, pointSec.posY-10, pointSec.posX+10, pointSec.posY-10);
            // 绘制第二段
            ctx.bezierCurveTo(pointSec.posX+b+5, pointSec.posY-8,pointThree.posX-b-10,pointThree.posY-12,pointThree.posX+10,pointThree.posY-b-7);
            // 绘制第三段
            ctx.bezierCurveTo(x+2*a,pointThree.posY-b*3+5, x+2*a, pointFour.posY-b-5,pointFour.posX-5,pointFour.posY-b-10);


        },
        getroundPos(x,y,Degrees,r){//坐标点计算
            let posX,posY;
        ...
        getRads (degrees) { //计算弧度
            return (Math.PI * degrees) / 180;
        },
        getDegrees (rads) { // 计算角度
